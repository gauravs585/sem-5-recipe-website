...
function handleSubmit(event) {
  ...
  const nameInput = document.querySelector('#recipe_name');
  const ingrInput = document.querySelector('#recipe_ingredients');
  const methodInput = document.querySelector('#recipe_method');
